...
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_RenderingServer_method_instance_reset_physics_interpolation>`{.interpreted-text
role="ref"}
...
`RID<class_RID>`{.interpreted-text role="ref"}, interpolated:
`bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_RenderingServer_method_instance_set_interpolated>`{.interpreted-text
role="ref"}
